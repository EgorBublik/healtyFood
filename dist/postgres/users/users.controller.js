...
let UsersController = class UsersController {
    ...
    async createUser(password, username, role, telegramId) {
    ...
    async deleteAssignPatientToDoctor(doctorId, patientId) {
...
__decorate([
    ...
    __param(3, (0, common_1.Body)('telegramId')),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Post)('/assign-patient/:doctorId/:patientId'),
    __param(0, (0, common_1.Param)('doctorId')),
    __param(1, (0, common_1.Param)('patientId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "assignPatientToDoctor", null);
__decorate([
    (0, common_1.Post)('/delete-assign-patient/:doctorId/:patientId'),
    __param(0, (0, common_1.Param)('doctorId')),
    __param(1, (0, common_1.Param)('patientId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "deleteAssignPatientToDoctor", null);
